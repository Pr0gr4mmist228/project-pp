...
namespace auth
{
	partial class ProductCard
	{
		...
		private void InitializeComponent()
		{
			...
			this.itemNamelabel.Text = "defaultText";
			// 
			// quantityLabel
			// 
			...
			this.quantityLabel.Text = "defaultText";
			// 
			// dateLabel
			// 
			...
			this.dateLabel.Text = "defaultText";
			// 
			// itemPicture
			// 
			...
			this.itemPicture.WaitOnLoad = true;
			// 
			// dateTimePicker
			// 
			...
			this.typeLabel.Text = "defaultText";
			// 
			// saveDateButton
			// 
			...
			this.saveDateButton.Click += new System.EventHandler(this.SaveDateButtonClick);
			// 
			// pictureBox1
			// 
			...
			this.dateMaskedTextBox.TabIndex = 11;
